...
export default function App() {
  ...
  const handleArchive = useCallback(async (todo) => {
    try {
      ...
      if (typeof todoId === 'string' && todoId.startsWith('temp-')) {
        console.error('Cannot archive a task with a temporary ID:', todoId);
        setError('This task is still being saved. Please wait a moment and try again.');
        return;
      }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 py-8 px-4 transition-colors duration-300">
      <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden transition-colors duration-300">
        <div className="p-8">
